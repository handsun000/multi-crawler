...
public class CrawlController {
    ...
    public CrawlController(NewsCrawler newsCrawler, NewsCrawlerService newsCrawlerService, EmployCrawlerService employCrawlerService) {
    ...
    @GetMapping("/employ")
    public String crawlEmploy() throws InterruptedException, IOException { return employCrawlerService.getInfinite("https://www.wanted.co.kr/wdlist/518?country=kr&job_sort=job.popularity_order&years=-1&locations=all");}
}
